import {differenceInCalendarISOWeeks, formatISO, endOfISOWeek, parseISO} from 'date-fns/';
import {getTodayDate} from './todaytasks.js';
...
export function displayWeekTasks() {
  ...
  allTasks.forEach(task => {
    ...
    if (differenceInCalendarISOWeeks(endOfWeek, taskDueDay) !== 0) task.parentElement.style.display = 'none';
  });
}